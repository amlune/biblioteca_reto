...
class Prestamo(Base):
    ...
    fecha_inicio = Column(DateTime, default=datetime.astimezone)
...
class Compra(Base):
    ...
    usuario_id = Column(Integer, ForeignKey("usuarios.id"), nullable=False)
    libro_id = Column(Integer, ForeignKey("libros.id"), nullable=False)
    fecha = Column(DateTime, default=datetime.astimezone)
...
class Reserva(Base):
    ...
    usuario_id = Column(Integer, ForeignKey("usuarios.id"), nullable=False)
    libro_id = Column(Integer, ForeignKey("libros.id"), nullable=False)
    fecha_creacion = Column(DateTime, default=datetime.astimezone)
    estado = Column(String, default="activo")